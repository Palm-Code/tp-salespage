  ...
  return (
    ...
    >
      ...
      >
        <ShieldHalf
          className={clsx(
            "w-[5rem] h-[5rem] sm:w-[150px] sm:h-[150px]",
            "text-[#472E75]"
          )}
        />
        <div
        ...
        >
          <span
            className={clsx(
              "text-[#2A1B45] text-[1.125rem] sm:text-[2.5rem] font-bold text-center"
            )}
          >
          ...
          <span
            className={clsx(
              "text-[#2A1B45] text-[0.75rem] sm:text-[1.125rem] font-normal text-center"
            )}
          >
