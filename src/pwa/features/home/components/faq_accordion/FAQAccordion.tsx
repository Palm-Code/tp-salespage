  ...
  return (
    <div
      className={clsx(
        ...
        "w-full",
        "px-[1rem] py-[1.5rem] md:px-[2rem] md:py-[2rem]",
        "rounded-[0.5rem]",
        "bg-[#F0ECF64D]"
      )}
    >
      ...
      >
        <span className={clsx("text-[#37245B] text-[0.875rem] md:text-[1.5rem] font-bold")}>
          {question}
        </span>
        {isOpen ? (
      ...
      <motion.div
        ...
        className={clsx("text-[#1D1D1D] text-[0.75rem] md:text-[1.25rem] font-normal")}
      >
        {answer}
      </motion.div>
    </div>
